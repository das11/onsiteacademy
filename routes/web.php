...
Route::get('oldhome', "HomeController@oldhome")->name("oldhome");
Route::get("coursehome", "HomeController@courseHome")->name("coursehome");
...
Route::post("handle_razorpay_callback", "GatewayController@handle_razorpay_payment");
